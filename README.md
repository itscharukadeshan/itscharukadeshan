...
- 🚀 Current daily Drivers: **🟢 Node.js / 📘 TypeScript / 🚂 Express / 📦 Prisma / 🐘 PostgreSQL and 🐳 Docker**
...
[![My Skills](https://skillicons.dev/icons?i=js,typescript,python,astro,svelte,next,nuxt,react,d3,nodejs,express,css,html,docker,git,github,jest,postman,tailwind,vite,postgres,graphql,supabase,bash,figma,webflow,vscode,idea&perline=14)](https://skillicons.dev)
